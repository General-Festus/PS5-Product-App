...
import 'package:ps5_product_app/models/controller.dart';
import 'package:ps5_product_app/models/option.dart';
import 'package:ps5_product_app/page/homepage/Item_card_shape.dart';
...
class _OptionWidget extends StatelessWidget {
  ...
  const _OptionWidget({Key key, @required this.option, this.isSelected = false})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Padding(
